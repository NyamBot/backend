...
class RestaurantAiService:
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "저장 맛집 후보는 저장 리뷰와 취향 근거를 중심으로 설명해. "
    ...
    def _build_prompt(
        ...
        lines = [
            ...
            "- 저장 맛집 후보는 저장 리뷰를 근거로 설명해.",
            "- 외부 장소 후보는 저장 리뷰라고 말하지 말고, 지역/종류/거리/접근성/요청 상황 적합성으로 설명해.",
        ...
        for index, recommendation in enumerate(recommendations, start=1):
            ...
            lines.extend(
                [
                    ...
                    f"- 후보 출처: {source_type}",
                    f"- 지역/종류/가격: {meta}",
                    f"- 태그: {', '.join(restaurant.mood_tags) or '없음'}",
                    f"- 추천 점수: {recommendation.score}",
                    f"- 판단 힌트: {recommendation.reason}",
                    f"- 저장 리뷰 또는 장소 특징: {evidence}",
        ...
        lines.extend(
            [
                ...
                "- 저장 리뷰가 없는 후보는 출처를 말하지 말고, 확인 가능한 장소 특징만 근거처럼 풀어줘.",
