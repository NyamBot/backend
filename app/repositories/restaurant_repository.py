...
# Repository layer.
# Spring 기준으로 보면 Repository 구현체에 해당한다. 현재는 SQLAlchemy Entity 대신
# sqlite3/psycopg SQL을 직접 사용하며, SQLite fallback과 PostgreSQL pgvector 구현을 함께 둔다.
...
class RestaurantRepository:
    """Repository facade that selects SQLite or PostgreSQL storage."""
